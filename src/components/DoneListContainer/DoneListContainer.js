...
const DoneListContainer = ({
  ...
  return (
    ...
    >
      <div className="flex 2xl:text-0.875rem xl:text-0.75rem xs:text-0.625rem lg:leading-5 xs:leading-3 text-deep-gray">
      ...
      <p className="overflow-y-scroll 2xl:w-150px 2xl:h-50px 2xl:text-1rem xl:w-100px xl:h-50px xl:text-0.875rem lg:w-70px lg:h-50px lg:text-0.75rem md:w-40px md:h-50px md:text-0.75rem sm:w-40px sm:h-50px sm:text-0.75rem xs:w-30px xs:h-40px xs:text-0.625rem ml-20px">
        {userToDo}
      </p>
