...
const CheckingModal = ({ onClick, closeModal, onRemovedList }) => {
  return (
    <div className="fixed top-[200px] left-0 right-0 bottom-0 flex flex-col z-[99] w-[400px] h-[200px] bg-middle-gray rounded-[5px]">
      <div className="fixed flex items-center justify-center w-[400px] h-[200px] z-[99] bg-light-black rounded-[5px]">
